...
const htmlWebpackMinifyConfig = {
  // Minifying it while it is parsed
  removeComments: true,
...
const config = {
  ...
  entry: {
    app: [path.join(consts.SRC_DIR, 'client/index.js')],
    widgets: [path.join(consts.SRC_DIR, 'client/widgets/index.js')],
    admin: [path.join(consts.SRC_DIR, 'client/admin/index.js')],
